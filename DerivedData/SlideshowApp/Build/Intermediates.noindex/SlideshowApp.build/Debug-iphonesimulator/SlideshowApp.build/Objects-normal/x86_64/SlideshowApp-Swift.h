...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SlideshowApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12SlideshowApp11AppDelegate")
...
SWIFT_CLASS("_TtC12SlideshowApp15ImageController")
@interface ImageController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageWideView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC12SlideshowApp13SceneDelegate")
...
SWIFT_CLASS("_TtC12SlideshowApp14ViewController")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified autoStart;
- (IBAction)unwind:(UIStoryboardSegue * _Nonnull)segue;
- (IBAction)onTapImage:(id _Nonnull)sender;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (IBAction)startButton:(id _Nonnull)sender;
- (IBAction)backButton:(id _Nonnull)sender;
- (IBAction)autoStart:(id _Nonnull)sender;
- (void)updateTimer:(NSTimer * _Nonnull)timer;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
